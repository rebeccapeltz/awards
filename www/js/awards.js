 ...
 d3.json("../data/awards.json", function (json) {
     ...
     var yearRingChart = dc.pieChart("#test_ring");
     ...
     //ndx1.add(json);
   /*  var countryDim = ndx1.dimension(function (d) {
             return d.country;
         }),
         grpCountryTotal = countryDim.group().reduceSum(function (d) {
             return +d.total;
         });*/
   ...
   var countryDim = ndx.dimension(function (d) {
    ...
    var grpCountryTotal = countryDim.group().reduceSum(function (d) {
     ...
     var barChart = dc.barChart("#test_bar");
